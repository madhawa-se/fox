 ...
 */
function fox_cash_theme_preprocess_page(&$vars, $hook) {
...
function fox_cash_theme_webform_grid($element) {
  $rows = array();
 ...
 */
function fox_cash_theme_breadcrumb($breadcrumb) {
 ...
 */
function fox_cash_theme_menu_local_tasks() {
  $output = '';
...
/**
 * fox_cash_theme_preprocess_search_theme_form().
 */
function fox_cash_theme_preprocess_search_theme_form(&$vars, $hook) {
 ...
 */
function fox_cash_theme_form_element($element, $value) {
 ...
 */
function fox_cash_theme_textfield($element) {
 ...
 * Override theme_textfield().
 */
function fox_cash_theme_webform_email($element) {
  // Add bootstrap classes
  $class = array('form-control');
 ...
 */
function fox_cash_theme_textarea($element) {
 ...
 */
function fox_cash_theme_password($element) {
 ...
 */
function fox_cash_theme_select($element) {
 ...
 */
function fox_cash_theme_checkbox($element) {
