     ...
     $.fn.extend({ 
         ...
         champ: function(options) {
            ...
            return this.each(function() {
                ...
                $(".controller .previous", $(this)).mouseover( function(){
                ...
                $(".controller .next", $(this)).mouseover( function(){
                    con_siblings = $(this).closest(".controller");
                ...
                tab_selector.each(function(){
                    var accordian_header = $(this).find(".fnt-services-title").text()
                    ...
                    tab_content_selector.each(function(){
                        if($(this).hasClass(add_relation)){
                           get_parent.find(" > div > div.tab_content." +add_relation).before("<div title='" + add_relation + "' class='accordian_header " + add_relation + ' ' + current_tab_class +"'>" + accordian_header + "</div>");
                        }
                    });
                ...
                tab_selector.mouseover(function(){
